...
import com.example.screentimeapp.helper.CsvHelper
import com.example.screentimeapp.helper.Logger
import com.example.screentimeapp.helper.NotTrackingListHelper
import com.example.screentimeapp.helper.ScreenUnlockHelper
...
data class UsageDigest(
    ...
    companion object {
        ...
        fun load(context: Context, day: String): UsageDigest {
            if (day == CalendarHelper.getDateCon(System.currentTimeMillis())) {
